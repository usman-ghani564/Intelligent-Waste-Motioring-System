...
class AdminGoogleMapsScreen extends StatefulWidget {
  Function getUserId = () {};
  AdminGoogleMapsScreen(this.getUserId);
  @override
  _AdminGoogleMapsScreenState createState() => _AdminGoogleMapsScreenState();
}
...
class _AdminGoogleMapsScreenState extends State<AdminGoogleMapsScreen> {
  ...
  void initState() {
    () async {
      ...
      locationsList = await complaintProvider.getAllComplaint();
