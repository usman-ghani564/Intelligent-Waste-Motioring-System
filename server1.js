...
app.post("/api/getimg", async (req, res) => {
  ...
  try {
    // Url of the image
    // const url =
    //   "https://firebasestorage.googleapis.com/v0/b/fyp-project-98f0f.appspot.com/o/images%2F74.254320131.40900858xgdcfdBVcNGkOR6d3bgdgwgijH32022-06-20%2023%3A20%3A48.963074?alt=media&token=8393e70a-278f-4b45-abfc-baaf987e73c2";
    // // Path at which image will get downloaded
    const filePath = `${__dirname}/testimg`;
    download(url.url, filePath).then(() => {
